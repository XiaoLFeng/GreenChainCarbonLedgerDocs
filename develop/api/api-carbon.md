...
> 钢铁生产企业的$CO_2$排放量等于企业边界内所有的化石燃料排放量、工业生产过程排放量及企业净购入热力隐含生产的$CO_2$排放量之和，还应扣除固碳产品隐含的排放量，

## 核算方法

### 计算方法

> $E_{CO_2}=E_{燃烧}+E_{电和热}-R_{固碳}$​

1. $E_{CO_2}$：企业$CO_2$排放总量，单位为吨（$tCO_2$​​）
2. $E_{燃烧}$：企业所有净消耗化石燃料燃烧活动产生的$CO_2$排放量，单位为吨（$tCO_2$）
3. $E_{过程}$：企业工业生产过程产生的$CO_2$排放量，单位为吨（$tCO_2$）
4. $E_{电和热}$：企业净购入电力和净购入热力产生的$CO_2$排放量，单位为吨（$tCO_2$）
5. $R_{固碳}$：企业固碳产品隐含的$CO_2$排放量，单位为吨（$tCO_2$）

### 燃料燃烧排放

> $E_{燃烧} = \sum_{i=1}^{n}(AD_i \times EF_i)$

1. $E_{燃烧}$：核算和报告期内净消耗化石燃料燃烧产生的$CO_2$排放量，单位为吨（$tCO_2$）
2. ${AD}_i$：核算和报告期内第$i$中化石燃料的活动水平，单位为百万千焦($GJ$)
3. ${EF}_i$：第$i$种化石燃料的二氧化碳排放因子，单位为$tCO_2/GJ$
4. $i$:净消耗化石燃料的类型

#### 核算和报告其内第$i$中化石燃料的活动水平${AD}_i$按下面公式计算

> $AD_i = NCV_i \times FC_i$

1. $NCV_i$ : 是核算和报告期第$i$中化石燃料的平均低位发热量，对固体或液体燃料，单位为百万千焦/吨（$GJ/t$);对气体燃料，单位为百万千焦/万立方米（$GJ/万Nm_3$）
2. $FC_i$ : 第i种化石燃料的消耗量，对固体或液体燃料，单位为吨（t）；对气体燃料，单位为万立方米（$万Nm3$)

#### 化石燃料的二氧化碳排放因子按下面公式计算

> $EF_i=CC_i \times OF_i \times \frac{44}{12}$

1. $CC_i$：是第i种化石燃料的单位热值含碳量，单位为吨碳/百万千焦（$tC/GJ$）

2. $OF_i$：是第i中化石燃料的碳氧化率，单位为%

### 活动水平数据获取

根据核算和报告期内各种化石燃料购入量、外销量、库存变化量以及除钢铁生产之外的其他消耗量来确定各自的净消耗量。化石燃料购入两、外销量采用采购单或销售单等结算凭证上的数据，库存变化量采用计量工具读书或其他符合要求的方法来确定，钢铁生产之外的其他消耗量一句企业能源平衡表获取，采用以下公式计算
